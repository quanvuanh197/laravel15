	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><span class="fa fa-edit"></span> User Edit</h4>
			</div>
			
			<form class="form-horizontal" action="" method="post" role="form" id="form-update-user" enctype="multipart/form-data">
