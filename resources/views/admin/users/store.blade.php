	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><span class="fa fa-user-plus"></span> User Add</h4>
			</div>
			
			<form class="form-horizontal" action="" method="post" data-url="{{ route('admin.userStore') }}" role="form" id="form-add-user" enctype="multipart/form-data">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="col-md-4">
							<div class="form-group">
								<span class="col-md-10 col-xs-12 btn btn-primary btn-file btn-file-add">
									<span class="fa fa-picture-o"></span> Image Upload<input type="file" name="image" id="image-upload-add" title="Browse file"/>
								</span>                                   					

								<br><div class="col-md-12">
									<img id='img-upload-add' src="" height="225px" width="225px" style="border-radius: 4px" /> 
								</div>                                          			
							</div>
